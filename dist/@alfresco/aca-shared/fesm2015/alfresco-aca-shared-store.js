...
class DialogEffects {
    ...
    constructor(actions$, matDialog) {
        ...
        this.closeAll$ = this.actions$.pipe(ofType(AppActionTypes.CloseModalDialogs), map(() => this.matDialog.closeAll()));
    }
}
...
class SnackbarEffects {
    ...
    constructor(store, actions$, snackBar, translationService) {
        ...
        this.infoEffect = this.actions$.pipe(ofType(SnackbarActionTypes.Info), map((action) => {
            this.showSnackBar(action, 'info-snackbar');
        }));
        this.warningEffect = this.actions$.pipe(ofType(SnackbarActionTypes.Warning), map((action) => {
            this.showSnackBar(action, 'warning-snackbar');
        }));
        this.errorEffect = this.actions$.pipe(ofType(SnackbarActionTypes.Error), map((action) => {
...
/** @type {?} */
const getHeaderColor = createSelector(selectApp, state => state.headerColor);
/** @type {?} */
const getAppName = createSelector(selectApp, state => state.appName);
/** @type {?} */
const getLogoPath = createSelector(selectApp, state => state.logoPath);
/** @type {?} */
const getLanguagePickerState = createSelector(selectApp, state => state.languagePicker);
/** @type {?} */
...
/** @type {?} */
const getSharedUrl = createSelector(selectApp, state => state.sharedUrl);
/** @type {?} */
...
/** @type {?} */
const showFacetFilter = createSelector(selectApp, state => state.showFacetFilter);
/** @type {?} */
const getDocumentDisplayMode = createSelector(selectApp, state => state.documentDisplayMode);
/** @type {?} */
