(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/router'), require('@alfresco/adf-core'), require('@angular/material/icon'), require('@angular/common'), require('@ngx-translate/core'), require('rxjs/operators'), require('rxjs'), require('@ngrx/store'), require('@alfresco/aca-shared/store'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@alfresco/aca-shared', ['exports', '@angular/router', '@alfresco/adf-core', '@angular/material/icon', '@angular/common', '@ngx-translate/core', 'rxjs/operators', 'rxjs', '@ngrx/store', '@alfresco/aca-shared/store', '@angular/core'], factory) :
    (factory((global.alfresco = global.alfresco || {}, global.alfresco['aca-shared'] = {}),global.ng.router,global['@alfresco/adf-core'],global.ng.material.icon,global.ng.common,global['@ngx-translate/core'],global.rxjs.operators,global.rxjs,global['@ngrx/store'],global.alfresco['aca-shared'].store,global.ng.core));
}(this, (function (exports,i2,i1,icon,common,core,operators,rxjs,i1$1,store,i0) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     * @return {?}
     */
    function DefaultExtensionLoaderFactory() {
        return [];
    }
    /** @type {?} */
    var EXTENSION_DATA_LOADERS = new i0.InjectionToken('EXTENSION_DATA_LOADERS', {
        providedIn: 'root',
        factory: DefaultExtensionLoaderFactory
    });
    var ExtensionsDataLoaderGuard = /** @class */ (function () {
        function ExtensionsDataLoaderGuard(extensionDataLoaders) {
         ...
         * @return {?}
         */
        ExtensionsDataLoaderGuard.prototype.canActivate = /**
         * @param {?} route
         * @return {?}
         */
            function (route) {
                ...
                /** @type {?} */
                var dataLoaderCallbacks = this.extensionDataLoaders.map(function (callback) {
                ...
                return rxjs.forkJoin.apply(void 0, __spread(dataLoaderCallbacks)).pipe(operators.map(function () { return true; }), operators.catchError(function (e) {
        ...
        /** @nocollapse */
        ExtensionsDataLoaderGuard.ctorParameters = function () {
            return [
                { type: Array, decorators: [{ type: i0.Inject, args: [EXTENSION_DATA_LOADERS,] }] }
            ];
        };
        ...
        return ExtensionsDataLoaderGuard;
    }());
    ...
    var PageLayoutContentComponent = /** @class */ (function () {
        ...
        PageLayoutContentComponent.propDecorators = {
            scrollable: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.scrollable',] }]
        };
    ...
    var PageLayoutComponent = /** @class */ (function () {
        ...
        PageLayoutComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        template: "<ng-content select=\"aca-page-layout-header\"></ng-content>\n<ng-content select=\"aca-page-layout-error\" *ngIf=\"hasError\"></ng-content>\n<ng-content select=\"aca-page-layout-content\" *ngIf=\"!hasError\"></ng-content>\n",
                        encapsulation: i0.ViewEncapsulation.None,
                        host: { class: 'aca-page-layout' },
                        changeDetection: i0.ChangeDetectionStrategy.OnPush,
                        styles: [".aca-page-layout{display:flex;flex-direction:column;flex:1;height:100%;overflow:hidden;min-height:0}.aca-page-layout .aca-page-layout-header{display:flex;align-items:center;flex:0 0 65px;flex-basis:48px;background:#fafafa;border-bottom:1px solid var(--theme-border-color,rgba(0,0,0,.07));padding:0 24px}.aca-page-layout .aca-page-layout-content,.aca-page-layout .aca-page-layout-error{display:flex;flex-direction:row;flex:1;height:100%;overflow:hidden}.aca-page-layout .main-content{display:flex;flex-direction:column;flex:1;height:100%;overflow:hidden;min-height:0}.aca-page-layout .scrollable,.aca-page-layout .scrollable .main-content{overflow:auto!important}.aca-page-layout .sidebar{display:block;height:100%;overflow-y:scroll;max-width:350px;width:350px}[dir=rtl] .aca-page-layout .main-content{border-left:1px solid var(--theme-border-color,rgba(0,0,0,.07))}[dir=ltr] .aca-page-layout .main-content{border-right:1px solid var(--theme-border-color,rgba(0,0,0,.07))}"]
                    }] }
        ];
    ...
    var LockedByComponent = /** @class */ (function () {
        ...
        LockedByComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        styles: [".aca-locked-by{display:flex;align-items:center;padding:0 10px;color:var(--theme-text-color,rgba(0,0,0,.54))}.aca-locked-by .locked_by--icon{font-size:14px;width:14px;height:14px}.aca-locked-by .locked_by--name{font-size:12px;padding:0 2px}"]
                    }] }
        ];
        /** @nocollapse */
        LockedByComponent.ctorParameters = function () { return []; };
    ...
    var AppRouteReuseStrategy = /** @class */ (function () {
         ...
         */
            function (route) {
                ...
                return route.parent
                    ? __spread(this.getFullRouteUrlPaths(route.parent), paths) : paths;
            };
        /**
         * @private
         * @param {?} route
    ...
    var AppSharedRuleGuard = /** @class */ (function () {
        ...
        /** @nocollapse */ AppSharedRuleGuard.ngInjectableDef = i0.defineInjectable({ factory: function AppSharedRuleGuard_Factory() { return new AppSharedRuleGuard(i0.inject(i1$1.Store)); }, token: AppSharedRuleGuard, providedIn: "root" });
    ...
    var AppService = /** @class */ (function () {
        function AppService(auth, config, routeStrategy) {
            var _this = this;
            this.config = config;
            this.ready = new rxjs.BehaviorSubject(auth.isLoggedIn() || this.withCredentials);
        ...
        AppService.ctorParameters = function () {
            return [
                ...
                { type: AppRouteReuseStrategy, decorators: [{ type: i0.Inject, args: [i2.RouteReuseStrategy,] }] }
            ];
        };
        /** @nocollapse */ AppService.ngInjectableDef = i0.defineInjectable({ factory: function AppService_Factory() { return new AppService(i0.inject(i1.AuthenticationService), i0.inject(i1.AppConfigService), i0.inject(i2.RouteReuseStrategy)); }, token: AppService, providedIn: "root" });
        return AppService;
    }());
    ...
    var ContentApiService = /** @class */ (function () {
         ...
         */
            function (nodeId, targetParentId, name, opts) {
                return rxjs.from(this.api.nodesApi.copyNode(nodeId, { targetParentId: targetParentId, name: name }, opts));
            };
        /**
         ...
         */
            function () {
                return rxjs.from(this.api.getInstance().discovery.discoveryApi.getRepositoryInformation());
            };
        /**
         * @param {?} personId
         * @param {?=} opts
         ...
         */
            function (personId, opts) {
                ...
                return this.getFavorites(personId, __assign({}, opts, { where: '(EXISTS(target/site))' })).pipe(operators.map(function (response) {
                    return {
                        list: {
         ...
         */
            function (nodes) {
                ...
                return rxjs.from(this.api.favoritesApi.addFavorite('-me-', ( /** @type {?} */(payload))));
            };
        /**
         * @param {?} nodes
         * @return {?}
         ...
         */
            function (nodes) {
                var _this = this;
                return rxjs.from(Promise.all(nodes.map(function (node) {
                    /** @type {?} */
    ...
    var NodePermissionService = /** @class */ (function () {
         ...
         */
            function (source, permissions, options) {
                ...
                if (Array.isArray(source)) {
                    source = source.filter(function (item) { return item; });
                    if (source.length > 0) {
        ...
        /** @nocollapse */ NodePermissionService.ngInjectableDef = i0.defineInjectable({ factory: function NodePermissionService_Factory() { return new NodePermissionService(); }, token: NodePermissionService, providedIn: "root" });
    ...
    var GenericErrorComponent = /** @class */ (function () {
        ...
        GenericErrorComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        template: "<mat-icon>error</mat-icon>\n<p class=\"generic-error__title\">\n  {{ text | translate }}\n</p>\n",
                        encapsulation: i0.ViewEncapsulation.None,
                        changeDetection: i0.ChangeDetectionStrategy.OnPush,
                        host: { class: 'aca-generic-error' },
                        styles: [".aca-generic-error{color:var(--theme-text-color,rgba(0,0,0,.54));display:flex;align-items:center;justify-content:center;flex-direction:column;width:100%;height:100%}.aca-generic-error__title{font-size:16px}.aca-generic-error mat-icon{color:var(--theme-warn-color,#f44336);font-size:52px;height:52px;width:52px}"]
                    }] }
        ];
    ...
    var GenericErrorModule = /** @class */ (function () {
        ...
        GenericErrorModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, icon.MatIconModule, core.TranslateModule.forChild()],
    ...
    var ContextActionsDirective = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                this.execute$
                    .pipe(operators.debounceTime(300), operators.takeUntil(this.onDestroy$))
        ...
        ContextActionsDirective.propDecorators = {
            ...
            onContextMenuEvent: [{ type: i0.HostListener, args: ['contextmenu', ['$event'],] }]
        };
    ...
    exports.DefaultExtensionLoaderFactory = DefaultExtensionLoaderFactory;
    exports.EXTENSION_DATA_LOADERS = EXTENSION_DATA_LOADERS;
    exports.ExtensionsDataLoaderGuard = ExtensionsDataLoaderGuard;
