...
var AppSharedRuleGuard = /** @class */ (function () {
    ...
    /** @nocollapse */ AppSharedRuleGuard.ngInjectableDef = i0.defineInjectable({ factory: function AppSharedRuleGuard_Factory() { return new AppSharedRuleGuard(i0.inject(i1.Store)); }, token: AppSharedRuleGuard, providedIn: "root" });
