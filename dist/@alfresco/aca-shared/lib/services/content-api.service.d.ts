...
import { MinimalNodeEntity, NodePaging, Node, DeletedNodesPaging, PersonEntry, NodeEntry, DiscoveryEntry, FavoritePaging, SharedLinkPaging, SearchRequest, ResultSetPaging, SiteBody, SiteEntry, FavoriteEntry } from '@alfresco/js-api';
export declare class ContentApiService {
     ...
     */
    deleteNode(nodeId: string, options?: {
        permanent?: boolean;
    }): Observable<void>;
    /**
     ...
     */
    getPerson(personId: string, options?: {
        fields?: Array<string>;
     ...
     */
    copyNode(nodeId: string, targetParentId: string, name?: string, opts?: {
    ...
    getFavorites(personId: string, opts?: {
        skipCount?: number;
        maxItems?: number;
        where?: string;
        fields?: Array<string>;
    }): Observable<FavoritePaging>;
    getFavoriteLibraries(personId?: string, opts?: any): Observable<FavoritePaging>;
    ...
    createSite(siteBody: SiteBody, opts?: {
        fields?: Array<string>;
