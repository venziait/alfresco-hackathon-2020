...
import { AuthenticationService, AppConfigService, AlfrescoApiService, UserPreferencesService } from '@alfresco/adf-core';
import { MatIconModule } from '@angular/material/icon';
import { CommonModule } from '@angular/common';
import { TranslateModule } from '@ngx-translate/core';
import { map, catchError, debounceTime, takeUntil } from 'rxjs/operators';
import { forkJoin, of, BehaviorSubject, from, Subject } from 'rxjs';
import { Store } from '@ngrx/store';
import { isQuickShareEnabled, ContextMenu } from '@alfresco/aca-shared/store';
import { Injectable, InjectionToken, Inject, NgModule, Component, ViewEncapsulation, ChangeDetectionStrategy, Input, HostBinding, Directive, HostListener, defineInjectable, inject } from '@angular/core';
...
/** @type {?} */
var EXTENSION_DATA_LOADERS = new InjectionToken('EXTENSION_DATA_LOADERS', {
    providedIn: 'root',
...
var ExtensionsDataLoaderGuard = /** @class */ (function () {
    ...
    function (route) {
        ...
        return forkJoin.apply(void 0, __spread(dataLoaderCallbacks)).pipe(map(function () { return true; }), catchError(function (e) {
    ...
    /** @nocollapse */
    ExtensionsDataLoaderGuard.ctorParameters = function () { return [
        { type: Array, decorators: [{ type: Inject, args: [EXTENSION_DATA_LOADERS,] }] }
    ]; };
    /** @nocollapse */ ExtensionsDataLoaderGuard.ngInjectableDef = defineInjectable({ factory: function ExtensionsDataLoaderGuard_Factory() { return new ExtensionsDataLoaderGuard(inject(EXTENSION_DATA_LOADERS)); }, token: ExtensionsDataLoaderGuard, providedIn: "root" });
...
var PageLayoutContentComponent = /** @class */ (function () {
    ...
    PageLayoutContentComponent.propDecorators = {
        scrollable: [{ type: Input }, { type: HostBinding, args: ['class.scrollable',] }]
    };
...
var AppSharedRuleGuard = /** @class */ (function () {
    ...
    /** @nocollapse */
    AppSharedRuleGuard.ctorParameters = function () { return [
        { type: Store }
    ]; };
    /** @nocollapse */ AppSharedRuleGuard.ngInjectableDef = defineInjectable({ factory: function AppSharedRuleGuard_Factory() { return new AppSharedRuleGuard(inject(Store)); }, token: AppSharedRuleGuard, providedIn: "root" });
...
var AppService = /** @class */ (function () {
    ...
    AppService.ctorParameters = function () { return [
        ...
        { type: AppRouteReuseStrategy, decorators: [{ type: Inject, args: [RouteReuseStrategy,] }] }
    ]; };
    /** @nocollapse */ AppService.ngInjectableDef = defineInjectable({ factory: function AppService_Factory() { return new AppService(inject(AuthenticationService), inject(AppConfigService), inject(RouteReuseStrategy)); }, token: AppService, providedIn: "root" });
    return AppService;
}());
...
var ContentApiService = /** @class */ (function () {
    ...
    function (personId, opts) {
        ...
        return this.getFavorites(personId, __assign({}, opts, { where: '(EXISTS(target/site))' })).pipe(map(function (response) {
            return {
                list: {
    ...
    /** @nocollapse */ ContentApiService.ngInjectableDef = defineInjectable({ factory: function ContentApiService_Factory() { return new ContentApiService(inject(AlfrescoApiService), inject(UserPreferencesService)); }, token: ContentApiService, providedIn: "root" });
...
var NodePermissionService = /** @class */ (function () {
    ...
    /** @nocollapse */ NodePermissionService.ngInjectableDef = defineInjectable({ factory: function NodePermissionService_Factory() { return new NodePermissionService(); }, token: NodePermissionService, providedIn: "root" });
...
export { DefaultExtensionLoaderFactory, EXTENSION_DATA_LOADERS, ExtensionsDataLoaderGuard, PageLayoutContentComponent, PageLayoutErrorComponent, PageLayoutHeaderComponent, PageLayoutComponent, PageLayoutModule, LockedByComponent, LockedByModule, AppRouteReuseStrategy, AppSharedRuleGuard, AppService, ContentApiService, NodePermissionService, GenericErrorComponent, GenericErrorModule, ContextActionsDirective, ContextActionsModule, isLocked, isLibrary, SharedModule };
